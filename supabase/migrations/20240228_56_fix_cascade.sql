-- Primeiro, remover todas as políticas que podem depender das funções
...
DROP POLICY IF EXISTS "triage_insert_update_policy" ON triage;
...
-- Criar função simples para verificar roles (sem recursão)
